...
export default function CustomerInfoForm({
  ...
  // Message informatif sur la stratégie de notification
  const renderNotificationInfo = () => {
    return (
      <div className="flex items-start text-blue-600 text-xs mt-1 p-2 bg-blue-50 dark:bg-blue-900/20 rounded-md">
        <MessageCircle className="w-3 h-3 mr-2 mt-0.5 flex-shrink-0 text-blue-500" />
        <div className="text-blue-700 dark:text-blue-300">
          <p className="font-medium">Notifications intelligentes</p>
          <p className="mt-1">
            Nous tenterons d'abord WhatsApp, puis SMS si nécessaire. 
            Aucune vérification préalable requise.
          </p>
        </div>
      </div>
    );
