...
const faqItems = [
  {
    ...
    answer:
      "Il est recommandé d'attendre 24 à 48 heures après votre séance pour permettre aux actifs de bien pénétrer.",
  },
  {
    question:
      "Puis-je utiliser mes produits capillaires habituels après le traitement ?",
    answer:
      "Il est préférable d'éviter les produits agressifs pendant au moins 5 jours après le traitement. Utilisez de préférence les produits recommandés par votre spécialiste.",
  },
  {
    question: "Comment puis-je maximiser les résultats de mon traitement ?",
    answer:
      "Pour maximiser les résultats, suivez scrupuleusement les conseils post-séance, utilisez régulièrement les produits recommandés, et maintenez une alimentation équilibrée riche en nutriments essentiels pour la santé capillaire.",
  },
  {
    question: "Que faire si je ne peux pas venir à mon rendez-vous ?",
    answer:
      "Veuillez nous informer au moins 24 heures à l'avance pour toute annulation ou report. Au-delà de ce délai, l'acompte ne sera pas remboursé.",
  },
];
...
export default function AfterSessionAndBookingSection() {
  ...
  return (
    ...
    >
      ...
      <DecorativeShape
        className="w-64 h-64 left-10 bottom-20"
        color="#e2b3f7"
      />
      ...
      <div className="container relative z-10 px-2">
        <div className="max-w-3xl mx-auto mb-16 text-center">
          ...
          <p className="max-w-2xl mx-auto text-lg text-gray-600 dark:text-gray-300">
            Tout ce que vous devez savoir pour optimiser vos résultats et
            préparer votre visite dans les meilleures conditions.
          </p>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex justify-center mb-8">
            <div className="flex gap-3 p-1 bg-gray-100 dark:bg-gray-800 rounded-full">
              ...
              >
                ...
                />
                <span className={activeTab === "conseils" ? "font-medium" : ""}>
              ...
              >
                ...
                />
                <span
                  className={activeTab === "conditions" ? "font-medium" : ""}
                >
          ...
          <div
            className={cn("space-y-8", activeTab !== "conseils" && "hidden")}
          >
            ...
            {afterSessionRecommendations.precautions.length > 0 && (
              <div className="animate-fade-in animate-delay-200">
                <Card className="overflow-hidden border-none shadow-md hover:shadow-lg transition-all duration-300 bg-gradient-to-br from-white to-gray-50 dark:from-gray-900 dark:to-gray-800">
                  ...
                  <CardContent>
                    <ul className="space-y-4">
                      {afterSessionRecommendations.precautions.map(
                        (precaution, index) => (
                          <li key={index} className="flex items-start">
          ...
          <div
            className={cn("space-y-8", activeTab !== "conditions" && "hidden")}
          >
                      ...
                      {bookingSteps.map((step, index) => (
                        <div key={index} className="relative">
                          <div className="flex flex-col items-center p-4 rounded-lg bg-[#bfe0fb]/10">
                            ...
                            <h3 className="mb-1 text-base font-medium text-gray-800 dark:text-white">
                              {step.title}
                            </h3>
                            <p className="text-sm text-center text-gray-600 dark:text-gray-400">
                              {step.description}
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-gray-700 dark:text-gray-300 text-sm">
                            {bookingConditions.cancellation}
                          </p>
                        </div>
                      </div>
