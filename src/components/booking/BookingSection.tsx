...
export default function BookingSection({ services }: BookingSectionProps) {
  return (
    ...
    >
      {/* Formes décoratives */}
      <DecorativeShape
        className="w-56 sm:w-72 h-56 sm:h-72 left-20 top-40"
        color="#ffb2dd"
      />
      <DecorativeShape
        className="w-48 sm:w-64 h-48 sm:h-64 right-10 bottom-20"
        color="#e2b3f7"
      />
      <DecorativeShape
        className="w-32 sm:w-40 h-32 sm:h-40 left-1/3 top-20"
        color="#bfe0fb"
      />
      ...
      <div className="container relative z-10 px-3 sm:px-4 mx-auto">
        <div className="max-w-3xl mx-auto mb-8 sm:mb-12 md:mb-16 text-center">
          ...
          <p className="max-w-2xl mx-auto text-base sm:text-lg text-gray-600 dark:text-gray-300">
            ...
            pour commencer votre parcours vers des cheveux plus sains.
          </p>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="p-4 sm:p-6 mt-8 sm:mt-12 rounded-lg bg-gradient-to-r from-[#ffb2dd]/10 to-[#e2b3f7]/10 border border-[#ffb2dd]/20">
            <div className="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-3 sm:gap-0">
              ...
              <div>
                <h3 className="mb-1.5 sm:mb-2 text-base sm:text-lg font-medium text-gray-800 dark:text-white">
                  Kit SHUGAMADE offert
                </h3>
                <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300">
                  Pour toute réservation d'un forfait, recevez un kit complet de
                  produits de soins adaptés à votre traitement, incluant spray
                  Coup de pep's, sérum Coup de pousse et derma roller
                  professionnel.
                </p>
              </div>
            </div>
