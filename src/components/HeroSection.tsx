...
const DecorativeShape = ({
  ...
  <div
    className={cn(
      "absolute rounded-full opacity-30 animate-pulse-slow blur-xl",
      className
    )}
...
export default function HeroSection({ scrollToSection }: HeroSectionProps) {
  return (
    ...
    >
      ...
      <DecorativeShape
        className="w-48 sm:w-64 h-48 sm:h-64 left-5 sm:left-10 top-20"
        color="#e2b3f7"
      />
      <DecorativeShape
        className="w-64 sm:w-96 h-64 sm:h-96 right-5 sm:right-10 bottom-10"
        color="#bfe0fb"
      />
      <DecorativeShape
        className="w-32 sm:w-40 h-32 sm:h-40 right-1/4 top-10"
        color="#ffb2dd"
      />
      ...
      <div className="container relative z-10 px-3 sm:px-4">
        <div className="grid items-center grid-cols-1 gap-8 sm:gap-12 lg:grid-cols-2">
          ...
          <div className="relative animate-fade-in text-center lg:text-left">
            <span className="inline-block px-2.5 sm:px-3 py-1 mt-4 mb-2 text-xs sm:text-sm font-medium rounded-full bg-gradient-to-r from-[#bfe0fb]/30 to-[#ffb2dd]/30 text-[#bb81d7] dark:text-[#89b6da] dark:from-[#e2b3f7]/40 dark:to-[#ffb2dd]/40 border border-[#e2b3f7]/50 shadow-sm">
            ...
            <h1 className="mb-4 sm:mb-6 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
              ...
              <span className="relative">
                cheveux
                <svg
                  className="absolute bottom-0 left-0 w-full h-2 sm:h-3 -z-10"
                  viewBox="0 0 200 8"
                >
                  <path
            ...
            <p className="mb-6 sm:mb-8 text-base sm:text-lg text-gray-700 dark:text-gray-200 font-medium mx-auto lg:mx-0 max-w-lg">
              ...
              androgénétique, cicatricielle…) et problèmes capillaires avec des
              soins 100% naturels et personnalisés pour des résultats visibles
              et durables.
            </p>
