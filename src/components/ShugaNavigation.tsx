...
export default function ShugaNavigation({ activeSection, scrollToSection }: NavigationProps) {
        ...
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-6">
            <Button 
              ...
              variant="ghost" 
              className={`${activeSection === 'home' ? 'text-brand-pink-dark' : 'text-gray-600 hover:text-brand-pink-dark'}`}
            >
              Accueil
            </Button>
            <Button 
              ...
              variant="ghost" 
              className={`${activeSection === 'services' ? 'text-brand-pink-dark' : 'text-gray-600 hover:text-brand-pink-dark'}`}
            >
              Services
            </Button>
            <Button 
              ...
              variant="ghost" 
              className={`${activeSection === 'testimonials' ? 'text-brand-pink-dark' : 'text-gray-600 hover:text-brand-pink-dark'}`}
            >
              Témoignages
            </Button>
            <Button 
