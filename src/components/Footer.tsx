...
const SocialLink = ({ href, icon: Icon, label }: SocialLinkProps) => (
  <a
    ...
    className="flex items-center gap-2 text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors duration-300 group"
    aria-label={label}
  >
    <span className="flex items-center justify-center w-8 h-8 rounded-full bg-gray-200/80 dark:bg-white/10 group-hover:bg-gray-300 dark:group-hover:bg-white/20 transition-colors duration-300">
...
const FooterLink = ({
  ...
  <li className="mb-2">
    <Link
      href={href}
      className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors duration-300 flex items-center group"
    >
...
export default function Footer({ scrollToSection }: FooterProps) {
  ...
  return (
    <footer className="relative bg-gray-50 dark:bg-gradient-to-br dark:from-gray-900 dark:to-gray-950 text-gray-800 dark:text-white pt-16 pb-8 overflow-hidden">
      {/* Éléments décoratifs */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4">
            <Logo size={60} />
            <p className="text-gray-600 dark:text-gray-400 mt-4 text-sm max-w-xs">
              Solutions naturelles et efficaces contre l'alopécie de traction et
              pour la santé de vos cheveux.
            </p>
          ...
          {/* Liens rapides */}
          <div>
            <h3 className="text-gray-900 dark:text-white font-semibold text-lg mb-4 relative inline-block">
              Liens rapides
            ...
            <ul className="space-y-3">
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-start text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors duration-300"
                >
        ...
        <div className="flex flex-col md:flex-row justify-between items-center border-t border-gray-200 dark:border-gray-800 pt-8 mt-8">
          ...
          <div className="flex items-center">
            <button
              ...
              className="flex items-center justify-center w-10 h-10 rounded-full bg-gray-200 dark:bg-white/10 hover:bg-gray-300 dark:hover:bg-white/20 transition-all duration-300 group mr-4"
