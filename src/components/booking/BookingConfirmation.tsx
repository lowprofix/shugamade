...
import { Check, Calendar, Clock, User, Phone, Mail, Share2, Download, Sparkles } from "lucide-react";
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    <h5 className="font-medium text-gray-800 dark:text-white">Service réservé</h5>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    <h5 className="font-medium text-gray-800 dark:text-white">Vos coordonnées</h5>
                    <p className="text-gray-700 dark:text-gray-300 mt-1">
                      {customerInfo.name}
                    </p>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h5 className="font-medium text-gray-800 dark:text-white">Adresse du salon</h5>
                    <p className="text-gray-700 dark:text-gray-300 mt-1">
                      Institut ShugaMade
                    </p>
            ...
            <div className="p-4 bg-[#ffb2dd]/10 rounded-lg border border-[#ffb2dd]/20">
              ...
              <p className="text-sm text-gray-700 dark:text-gray-300 mt-2">
                Pour confirmer votre réservation, veuillez verser un acompte de 5 000 FCFA via MoMo au 06 597 56 23 ou via Airtel au 05 05 092 89 99.
              </p>
              <p className="text-sm text-gray-700 dark:text-gray-300 mt-2">
                <span className="font-medium">Important :</span> Veuillez mentionner votre numéro de réservation ({bookingNumber}) lors du paiement.
              </p>
            </div>
            ...
            {service.isPromo && (
              <div className="p-4 bg-gradient-to-r from-[#e2b3f7]/10 to-[#ffb2dd]/10 rounded-lg border border-[#e2b3f7]/20">
                ...
                <p className="text-sm text-gray-700 dark:text-gray-300 mt-2">
                  Votre kit comprend : Spray Coup de pep's, sérum Coup de pousse et derma roller professionnel.
                </p>
                <p className="text-sm text-gray-700 dark:text-gray-300 mt-2">
