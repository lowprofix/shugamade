...
const InfoBadge = ({
  ...
  return (
    <div
      className={cn(
        "flex items-center gap-3 p-3 rounded-lg bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border border-[#e2b3f7]/30 shadow-sm transition-all hover:shadow-md hover:border-[#e2b3f7]/50",
        className
      )}
    >
      {href ? (
...
export default function ContactSection() {
  ...
  return (
    ...
    >
      {/* Formes décoratives */}
      <DecorativeShape
        className="w-48 sm:w-72 h-48 sm:h-72 left-10 top-20"
        color="#ffb2dd"
      />
      <DecorativeShape
        className="w-48 sm:w-64 h-48 sm:h-64 right-10 bottom-40"
        color="#e2b3f7"
      />
      <DecorativeShape
        className="w-32 sm:w-40 h-32 sm:h-40 left-1/3 bottom-20"
        color="#bfe0fb"
      />
      ...
      <div className="container relative z-10 px-3 sm:px-4 mx-auto">
        <div className="max-w-3xl mx-auto mb-8 sm:mb-12 md:mb-16 text-center">
          ...
          <p className="max-w-2xl mx-auto text-base sm:text-lg text-gray-600 dark:text-gray-300">
            ...
            services, produits ou pour planifier un rendez-vous personnalisé.
          </p>
        </div>
              ...
              <div className="p-4 sm:p-6 md:p-8">
                ...
                <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    ...
                    nous fournissez ne seront utilisées que pour répondre à
                    votre demande.
                  </p>
                </div>
              </div>
            ...
            <Card className="overflow-hidden border-none shadow-lg bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm">
              ...
              <div className="p-4 sm:p-6">
                ...
                <p className="mb-4 text-sm sm:text-base text-gray-600 dark:text-gray-300">
                  ...
                  gratuitement notre kit complet comprenant:
                </p>
